> Historical design, archived 5 September 2026. This is not the current configuration or support contract. See [the current specification](../../ha-energy-planner-spec.md).
