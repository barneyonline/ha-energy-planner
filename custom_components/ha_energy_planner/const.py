...
PLATFORMS = ["sensor", "binary_sensor", "switch", "button", "calendar", "select"]
...
CONF_CLIMATE_ZONES = "climate_zone_entities"
CONF_CLIMATE_CHANGE_FROM_SCHEDULER = "climate_change_from_scheduler_entity"
CONF_CLIMATE_SCHEDULER_GUARD_TIMER = "climate_scheduler_guard_timer_entity"
...
CONF_LOAD_RECOVERY_MAX_AGE_MINUTES = "load_recovery_max_age_minutes"
CONF_HOUSEHOLD_LOAD_OUTAGE_GRACE_MINUTES = "household_load_outage_grace_minutes"
...
CONF_BYPASS_SAFETY_GATES = "bypass_safety_gates"
...
DEFAULT_OPTIONS = {
    ...
    CONF_MANUAL_HVAC_OVERRIDE_MINUTES: 60,
    ...
    CONF_HOUSEHOLD_LOAD_OUTAGE_GRACE_MINUTES: 30,
    CONF_LOAD_RECOVERY_MAX_AGE_MINUTES: 15,
    CONF_MATERIAL_CHANGE_THRESHOLD_PERCENT: 5.0,
    CONF_ENPHASE_MIN_SAVINGS: 0.25,
    CONF_COMMAND_RATE_LIMIT_SECONDS: 60,
    CONF_MAX_DAILY_EV_ACTIONS: 10,
    CONF_MAX_DAILY_CLIMATE_ACTIONS: 12,
    ...
    CONF_BYPASS_SAFETY_GATES: False,
}
