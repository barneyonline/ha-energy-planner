...
def _context_from_fixture(data: dict[str, Any]) -> DecisionContext:
    return DecisionContext(
        ...
        occupied_temperature_low_c=data.get("occupied_temperature_low_c"),
        occupied_temperature_high_c=data.get("occupied_temperature_high_c"),
        hvac_control=dict(data.get("hvac_control", {})),
        climate_inputs=dict(data.get("climate_inputs", {})),
